...
import 'package:cropkart/src/pages/Landing_pages/welcome.dart';
...
class _FarmerHomescreenState extends State<FarmerHomescreen> {
  ...
  Future<void> fetchCrops() async {
    try {
      ...
      List<Map<String, dynamic>> fetchedCrops =
          cropSnapshot.docs.map((doc) {
            return {
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            icon: Icon(Icons.refresh, color: Color.fromRGBO(51, 114, 51, 1.0)),
          ),
        ],
      ),
      drawer: Drawer(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    /// User Name
                    Text(
                      "Prashant Yadav", // fetch from Firebase
                      style: TextStyle(
                        color: Colors.white,
                        fontFamily: 'Poppins-SemiBold',
                        fontSize: 16,
                    ...
                    /// User Email
                    Text(
                      "prshntydv@gmail.com", // fetch from Firebase
                      style: TextStyle(
                  ...
                  return InkWell(
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder:
                              (context) => Farmercropdetailcrop(crop: crop),
                        ),
                      );
                    },
                    child: Card(
